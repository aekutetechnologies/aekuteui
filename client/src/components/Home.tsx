...
const Home = () => {
  return (
    <div className="min-h-[100vh] text-white flex flex-col ">
     <Navbar/>

      <main className="flex items-center justify-center h-[87vh]">
        <section className="flex flex-col items-center justify-center container mx-auto gap-10  ">
          <div>
            <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold">Animate your website</p>
          </div>
